...
var CONST = exports.CONST = {
    ...
    setUser: function setUser(obj) {
        this.user = _extends({}, this.user, { obj: obj });
    }
};
...
var User = function () {
    ...
    _createClass(User, [{
        ...
        value: function getInstagramAccount(formData) {
            var setting = _extends({}, this.settingPost, {
                method: 'GET',
                headers: _extends({}, this.settingPost.headers, {
                    token: this.getToken()
...
function viewUtils() {
    function showInfoMessage(selector, message1, message2) {
        (0, _jquery2.default)(selector).empty().append('<p>status: ' + message1 + '</p>').append('<p> message: ' + message2 + ' </p>');
    }
    ...
    function fillList($list, dataArray) {
        ...
        items.forEach(function (item, i) {
            var li = (0, _jquery2.default)('<li class="list-group-item"></li>').appendTo(cList);
            (0, _jquery2.default)('<a/>').addClass('ui-all').text(item.username).appendTo(li);
        });
    }
...
var _registerForm = __webpack_require__(10);

var _registerForm2 = _interopRequireDefault(_registerForm);

var _loginForm = __webpack_require__(9);
    ...
    var sendConfirm = function sendConfirm(token) {
        user.confirm(token).then(function (result) {
            if (result.status && result.status.state === 'ok') {
                ...
                (0, _jquery2.default)('.confirm-registration').append('<p>confirmation status: ' + result.status.state + '</p>');
                setTimeout(function () {
...
function emailNotConfirmed() {
    var $emailnMsg = (0, _jquery2.default)(selectorEmailConfirmState);
    $emailnMsg.text('**emailNotConfirmed** Email не подтвержден.').css('color', 'lightcoral');
}

function onLoginSubscribe(msg, data) {
    // console.log(msg, data);
    (0, _jquery2.default)(_consts.CONST.uiSelectors.headerNavLoginBtn).addClass('d-none').removeClass('d-block');
    (0, _jquery2.default)(_consts.CONST.uiSelectors.headerRegBtn).addClass('d-none').removeClass('d-block');
    (0, _jquery2.default)(_consts.CONST.uiSelectors.headerLoginBox).addClass('d-none').removeClass('d-block');
    var $loginMsg = (0, _jquery2.default)(selectorLoginState);
...
function showLogout() {
    ...
    if (isLogged) {
        (0, _jquery2.default)('.nav-link.js_logOut').parent().show();
        (0, _jquery2.default)('.profile-user').append('<span class="js_email-confirm--text" style="color: lightcoral"> вы залогинились успешно ---</span>');
        var oldURL = document.referrer;
        // console.log(oldURL);
        if (oldURL.includes('confirm-registration')) {
            (0, _jquery2.default)('.profile-user').append('<p class="js_message_logged--text" style="color: #536caf">вы подтвердили регистрацию</p>');
        }
        onLoginSubscribe();
    } else {
        (0, _jquery2.default)(selectorLoginState).text('Привет анонимный пользователь');
        (0, _jquery2.default)(selectorEmailConfirmState).empty();
    }
}
...
function initHeader() {
    ...
    var $loginBox = (0, _jquery2.default)(_consts.CONST.uiSelectors.headerLoginBox);
    var $registerBox = (0, _jquery2.default)(_consts.CONST.uiSelectors.headerRegBox);

    _pubsubJs2.default.subscribe(_consts.CONST.events.USER_LOGGED, onLoginSubscribe);

    showLogout();

    (0, _jquery2.default)(_consts.CONST.uiSelectors.headerRegBtn).on('click', function () {
        $loginBox.hide();
        $registerBox.css({ 'top': 0, 'right': 0 }).addClass('bg-light border mt-5 mx-auto position-absolute px-3 d-block').removeClass('d-none');
    });

    (0, _jquery2.default)(_consts.CONST.uiSelectors.headerNavLoginBtn).on('click', function () {
...
/* eslint-disable sort-vars */
window.$ = _jquery2.default; // https://www.npmjs.com/package/pubsub-js
function LoginForm(selectorCss) {
    ...
    var user = _user2.default,
        // service
    $form = (0, _jquery2.default)(_formId),
        $email = $form.find('input[name="mail"]'),
        $textAreaDescription = (0, _jquery2.default)('#description');
    ...
    var userLoginHeader = function userLoginHeader(_formData) {
        var cbError = function cbError(result) {
            (0, _jquery2.default)(_loginBox).append('<p>result.status.message</p>');
        };
    ...
    var addInstagramAccount = function addInstagramAccount(newFormData) {
        var cbError = function cbError(result) {
            _view2.default.showInfoMessage($textAreaDescription, result.status.state, result.status.message || 'Login error');
            (0, _jquery2.default)(_loginBox).addClass(closeClass).removeClass(openedClass);
        };

        user.addInstagramAccount(newFormData, cbError).then(function (result) {
            if (result && result.status) {
                console.log(result);
                _view2.default.showInfoMessage($textAreaDescription, result.status.state, result.status.message || 'Login error');
                (0, _jquery2.default)(_loginBox).addClass(closeClass).removeClass(openedClass);
    ...
    var submitForm = function submitForm(formDataObj) {
        ...
        if (selectorCss.isLoginInstagram) {
            addInstagramAccount({ username: $form.find('input[name="username"]').val(), password: password });
        } else {
    ...
    var bindEvents = function bindEvents() {
        var $showLoginBoxBtnId = (0, _jquery2.default)(_showLoginBoxBtnId);
        var $loginBox = (0, _jquery2.default)(_loginBox);
        var openedClass = 'd-block';
        var closeClass = 'd-none';
        ...
        var $buttonSubmit = (0, _jquery2.default)(_buttonSubmitId),
        ...
        (0, _jquery2.default)('.nav-link.js_logOut').on('click', function (e) {
            e.preventDefault();
            logOut();
            (0, _jquery2.default)(e.target).parent().hide();
        ...
        _pubsubJs2.default.subscribe(_consts.CONST.events.USER_LOGOUT, function (msg) {
            (0, _jquery2.default)(_consts.CONST.uiSelectors.headerNavLoginBtn).addClass(openedClass).removeClass(closeClass); // .show();
            (0, _jquery2.default)(_consts.CONST.uiSelectors.headerRegBtn).addClass(openedClass).removeClass(closeClass);
            (0, _jquery2.default)('.nav-link.js_logOut').addClass(closeClass).removeClass(openedClass); // .hide();
            var selectorLoginState = '.js_message_logged--text';
            (0, _jquery2.default)(selectorLoginState).text('Вы вышли из аккаунта');
        });

        (0, _jquery2.default)(document).on('click', function (event) {
            var isLoginBtnClick = (0, _jquery2.default)(event.target).closest('nav.navbar').find($loginBox).length;
            var isAddInstagramBtnClicked = (0, _jquery2.default)(event.target).attr('id') === _consts.CONST.uiSelectors.instagram.addAccountBtnId;
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // https://www.npmjs.com/package/pubsub-js
...
var RegisterForm = function () {
    function RegisterForm() {
        ...
        this.$form = (0, _jquery2.default)('#js_form');
        this.$email = this.$form.find('input[name="mail"]');
        this.$textAreaDescription = (0, _jquery2.default)('#description');
    ...
    _createClass(RegisterForm, [{
        ...
        value: function submitForm(formDataObj) {
            ...
            this.user.register(this.formData).then(function (result) {
                ...
                if (result && result.status) {
                    ...
                    (0, _jquery2.default)('.login-box').show();
                }
            }).catch(function (error) {
        ...
        value: function bindEvents() {
            ...
            (0, _jquery2.default)(document).on('click', function (event) {
                var isRegBtnClick = (0, _jquery2.default)(event.target).closest('nav.navbar').find('.register-box').length;
                // console.log('hasClass', $(registerBox).hasClass(openedClass));
                // console.log('isRegClick', isRegClick);

                if (!isRegBtnClick && (0, _jquery2.default)(registerBox).hasClass(openedClass)) {
                    (0, _jquery2.default)(registerBox).addClass(closeClass).removeClass(openedClass);
                }
            });
        }
    }]);
...
var Network = function () {
    ...
    _createClass(Network, [{
        ...
        value: function cbErrorDefault(result) {
            _view2.default.showInfoMessage((0, _jquery2.default)('#description'), result.status.state, result.status.message || 'Login error');
        }
    }, {
        key: 'checkStatus',
...
function Instagram() {
    ...
    var $buttonSubmit = (0, _jquery2.default)('#js_instagram-get-accounts--btn');
    var user = _user2.default,
        // service
    $list = (0, _jquery2.default)('.instagram-accounts-list');
