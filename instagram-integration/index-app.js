...
var CONST = exports.CONST = {
    url: {
        ...
        instagramTaskManager_getLogsChatBot: function instagramTaskManager_getLogsChatBot(type, subtype, username) {
            return 'instagram-task-manager/logs/type/' + type + '/subtype/' + subtype + '/account/' + username;
        }
    },
    user: {
        email: '',
    ...
    getPathTypeSubtype: function getPathTypeSubtype(name, path) {
        var type = path.type,
...
var UserTaskManager = function () {
    ...
    _createClass(UserTaskManager, [{
        ...
        key: 'getLogsChatBot',
        value: function getLogsChatBot(path, cbError) {
            // const {type, subType, username} = path;
            return this.network.sendRequest('' + _consts.CONST.getPathTypeSubtype('instagramTaskManager_getLogsChatBot', path), this.getToken('asHeader'), cbError);
        }
    }]);
...
function init() {
    if ($('.chat-bot-page').length) {
        ...
        _apiTaskManager2.default.getLogsChatBot(path).then(function (result) {
