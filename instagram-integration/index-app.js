...
var token = _user2.default.getToken(); // import * as data from './dataServer';
...
function addHandlers() {
    ...
    $('#sendMessageButton').on('click', function (e) {
        ...
        _apiUserDirect2.default.postMetadataDetailConversation(token, { username: username, conversationId: conversationId }).then(function (result) {
            console.log(result);
        });
    });
...
var UserConversation = function () {
    ...
    _createClass(UserConversation, [{
        ...
        value: function postMetadataDetailConversation(token, details, cbError) {
            ...
            return this.network.sendRequest(_consts.CONST.getPath('instagramDirect_getMetaData') + '/' + details.username + '/' + details.conversationId + '/text', setting, cbError);
        }
    }, {
